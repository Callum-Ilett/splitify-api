...
SECRET_KEY = "django-insecure-5wc994c08w=ix+%0q-z#dfi%@l-n26@cwdgdp9*z9_h=5#-ky3"
...
JWT_AUTH = {
    ...
    "JWT_ALGORITHM": "RS256",
    "JWT_AUDIENCE": "https://splitify.com/api",
    "JWT_ISSUER": "https://dev-282pztsm.eu.auth0.com/",
